...
public class PgpDataEncryptor
{
	...
	public static String encryptAndSign(String plainData, String recipientPublicKey, String senderPrivateKey)
	...
	public static void encryptAndSign(InputStream dataIn, InputStream recipientPublicKeyFileIn, String dataFileName,
