...
<body>
	...
	<%
		...
		try{
			...
			String sql1 = "SELECT * FROM MESSAGES WHERE FROMID = ?" ;
	...
	<div class="card">
		<div class="card-header">
			  ...
			  <div class="card-body">
			    <h5 class="card-title"><td><%=f.get(i).getTo() %></td></h5>
			    <p class="card-text"><%=new String(f.get(i).getSmsg())%></p>
		</div>
	</div>	
	<% } %>
